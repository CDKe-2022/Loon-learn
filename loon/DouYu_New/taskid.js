...
// 提取 VideoBenefitModule 模块中的任务ID
var a = obj.Data.VideoBenefitModule.TaskList[0].TaskId;  // 第一个任务的 ID
var b = obj.Data.VideoBenefitModule.TaskList[1].TaskId;  // 第二个任务的 ID
var c;  // 用于存储额外任务的 TaskId

// 遍历 CountdownBenefitModule 模块中的任务列表，查找特定标题的任务
for (var i = 0; i < obj.Data.CountdownBenefitModule.TaskList.length; i++) {
  // 如果任务标题为 "额外看3次小视频得奖励"
  if (obj.Data.CountdownBenefitModule.TaskList[i].Title == "额外看3次小视频得奖励") {
    // 获取该任务的 TaskId，并保存
